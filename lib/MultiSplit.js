...
const MultiSplit = ({ paystackKey, billingEmail, phone, lastName, firstName, amount = '0.00', currency = 'NGN', channels = ['card'], refNumber, billingName, handleWebViewMessage, onCancel, autoStart = false, onSuccess, activityIndicatorColor = 'green', subAccount, bearer, transactionCharge, splitCode }, ref) => {
...
exports.default = react_1.forwardRef(MultiSplit);
